...
export default function Home() {
  return (
    <main className="min-h-dvh flex items-center justify-center">
      <Card className="w-[21.25rem] sm:rounded-2xl rounded-xl sm:w-[42.5rem] sm:p-6 p-4 gap-6 sm:gap-12 flex flex-col shadow-md border-2 sm:border border-gray-200">
        <Image
          src="./logo-sa.svg"
          alt="logo"
          width={179}
        ...
        <CardHeader className="p-0">
          <CardTitle className="w-[14.75rem] font-normal text-[1.375rem]/[1.05em] sm:w-[27.5rem] sm:text-[2.5rem]/[1.05em] font-bank-gothic">
